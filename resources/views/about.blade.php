            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-10 text-center mx-auto position-relative">
                        ...
                        <!-- Title -->
                        <h1 class="position-relative fs-2">GTS Learning platform, built specifically for learners who
                            are interested in improving their careers by learning in an involving environment with
                            peers.</h1>
                    </div>
                    <!-- Title and SVG END -->
                </div>
...
About founder START -->
        <section class="pt-0 pt-md-5">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-lg-8">
                        <h2>About GTS Learning</h2>
                        <p class="mb-0">We are the leading skills improvement EdTech startup lead by the most amazing
                            tutors who aim to share knowledge based on their vast experiences in various fields. We
                            would like to partner with anyone out there to make everyone's dream a reality.</p>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 position-relative">
                        ...
                        <figure class="position-absolute top-0 start-0 d-inline-block mt-n3">
                            <svg width="180" height="188" viewbox="0 0 379 395"
                    ...
                    <div class="col-lg-7 mt-4 mt-lg-0">
                        <!-- Title -->
                        <h4 class="mb-3">30+ happy students joined with us to achieve their goals</h4>

                        <!-- Content -->
                        <p>We are eager to meet you and help in your learning journey </p>
                        <p>We also will like to partner with you in your journey to spreading knowledge and awareness
                        </p>

                        <!-- Info -->
                        <ul class="list-group list-group-borderless mt-4">
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>Online courses ensure you learn
                                at the comfort of your home
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>Experienced tutors who are
                                ready to share their knowledge on their areas of expertese
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>24/7 support with tutors a
                                click away in case you get stuck
                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-4 mb-md-0">
                        <!-- Title -->
                        <h2>Watch this pace</h2>
                        <!-- Content -->
                        <ul class="list-group list-group-borderless mt-4">
                            <!-- Award item -->
                            <li class="list-group-item d-flex align-items-center px-0">
                                <h6 class="mb-0">2023</h6>
                                <span class="fs-6 ms-3">Launching of our digital learning platform</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center px-0">
                                <h6 class="mb-0">2022</h6>
                                <span class="fs-6 ms-3">GTS Founded</span>
                            </li>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-sm-flex justify-content-sm-between">
                            ...
                            <a href="{{ url('/contact_gts_learning') }}" class="btn btn-light mt-2">Join Team</a>
                        </div>
