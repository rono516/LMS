                ...
                <div class="row py-5">
                    <div class="col-lg-8">
                        ...
                        <p>All GTS courses are tailored to cover in depth fundamentals of the topic. You will be
                            provided with video, text and documents necessary according to the tutors perspective and
                            experience on how
                                    ...
                                    <div class="card mb-0 mb-md-4">
                                        <div class="row g-0 align-items-center">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="card-body">
                                                    <!-- Title -->
                                                    <h3 class="card-title mb-0">{{ $course->teacher }}</h3>
                                                    <p class="mb-2">Instructor of {{ $course->title }}</p>
                                                    <!-- Social button -->
