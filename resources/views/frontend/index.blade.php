<!-- This is the beginning of the new frontend code-->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <!-- Content -->
                        <p class="my-4 lead">Online learning and teaching platform with 10+ courses & 200 students.
                    ...
                    <div class="col-lg-7 col-xl-6 text-center position-relative">
                        ...
                        <div class="position-relative">
                            ...
                            <img src="assets/images/gts_no_bg.png" alt="">
                        </div>
                    </div>
                    <!-- Right content END -->
                </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div
                            ...
                            <div class="ms-4 h6 fw-normal">
                                <div class="d-flex">
                                    <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
                                        data-purecounter-end="5" data-purecounter-delay="5">0</h5>
                                    <span class="mb-0 h5">+</span>
                                </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div
                            ...
                            <div class="ms-4 h6 fw-normal">
                                <div class="d-flex">
                                    <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
                                        data-purecounter-end="60" data-purecounter-delay="100">0</h5>
                                    <span class="mb-0 h5">+</span>
                                </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div
                            ...
                            <div class="ms-4 h6 fw-normal">
                                <div class="d-flex">
                                    <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
                                        data-purecounter-end="6" data-purecounter-delay="20">0</h5>
                                    <span class="mb-0 h5">+</span>
                                </div>
                                ...
                                <div class="col-11 mx-auto position-relative">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <p class="text-white mb-3 mb-lg-0">Most times the best way to grasp topics
                                                is by teaching. Sharing knowledge with us is the best way to improve
                                                yourself whilst helping others develop their skills. Contact us today to
                                                onboard your courses on our platform as we partner together in this
                                                journey with you.</p>
                                        </div>
                                        <!-- Content and input -->
                                        <div class="col-lg-5 text-lg-end">
                                            <a href="{{ url('/contact_gts_learning') }}"
                                                class="btn btn-outline-warning mb-0">Start Teaching
                                                Today</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card action-trigger-hover border">
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <div class="hstack gap-3">
                                                <span class="h6 fw-light mb-0"><i
                                                        class="far fa-clock text-danger me-2"></i>{{ $course->duration }}mins</span>
                                                <span class="h6 fw-light mb-0"><i
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="mb-0 ms-2"><a href="#"
                                                            class="h6 fw-light mb-0">{{ $course->teacher }}</a></p>
                                                </div>
                                                <!-- Price -->
                                                <div>
            ...
            <div class="container">
                <div class="row g-4 g-lg-5 align-items-center">
                                ...
                                <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                    ...
                                    <blockquote>
                                        <p>
                                            ...
                                            I have learned a lot from the courses provided by GTS with immersive
                                            learning material to gain from.
                    ...
                    <div class="col-xl-5 order-1 text-center text-xl-start">
                        ...
                        <p>I have learned a lot from the courses provided by GTS with immersive
                            learning material to gain from.</p>
